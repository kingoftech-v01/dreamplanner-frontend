  ...
  return (
    <PageLayout header={
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, paddingBottom: 32 }}>
        ...
        {!blocksQuery.isLoading && timeBlocks.filter(function (b) { return b.title || b.label; }).map(function (block, index) {
        ...
        {/* Empty state */}
        {!blocksQuery.isLoading && timeBlocks.filter(function (b) { return b.title || b.label; }).length === 0 && (
          <div style={{
            ...
            <GradientButton gradient="primary" onClick={openAddModal} icon={Plus}>
              Add Time Block
            </GradientButton>
          </div>
        )}
      ...
      <GlassModal
        ...
        variant="center"
        maxWidth={380}
        title={editingBlock ? "Edit Time Block" : "New Time Block"}
      >
        <div style={{ padding: 24 }}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <select
              ...
              style={{
                ...
                background: "var(--dp-surface)", border: "1px solid var(--dp-input-border)",
                color: "var(--dp-text)", fontSize: 14, outline: "none", boxSizing: "border-box",
          ...
          <div style={{ marginBottom: 20 }}>
            <label style={{
              ...
              color: "var(--dp-text-secondary)", marginBottom: 8,
            }}>
              <Palette size={13} />
              Color
            </label>
