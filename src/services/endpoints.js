...
export var DREAMS = {
  ...
  ANALYTICS: function (id, range) { return "/api/dreams/dreams/" + id + "/analytics/" + (range ? "?range=" + range : ""); },
  ...
  PREDICT_OBSTACLES: function (id) { return "/api/dreams/dreams/" + id + "/predict-obstacles/"; },
  CONVERSATION_STARTERS: function (id) { return "/api/dreams/dreams/" + id + "/conversation-starters/"; },
  SIMILAR: function (id) { return "/api/dreams/dreams/" + id + "/similar/"; },
  GOALS: {
  ...
  TASKS: {
    ...
    CHAIN: function (id) { return "/api/dreams/tasks/" + id + "/chain/"; },
  ...
  JOURNAL: {
    ...
    DETAIL: function (id) { return "/api/dreams/journal/" + id + "/"; },
  },
  FOCUS: {
  ...
  PROGRESS_PHOTOS: {
    LIST: function (dreamId) { return "/api/dreams/dreams/" + dreamId + "/progress-photos/"; },
    UPLOAD: function (dreamId) { return "/api/dreams/dreams/" + dreamId + "/progress-photos/upload/"; },
    ANALYZE: function (dreamId, photoId) { return "/api/dreams/dreams/" + dreamId + "/progress-photos/" + photoId + "/analyze/"; },
  },
};
...
export var CONVERSATIONS = {
  ...
  SUMMARIZE_VOICE: function (id, msgId) { return "/api/conversations/" + id + "/summarize-voice/" + msgId + "/"; },
  ...
  SEARCH_MESSAGES: function (id, q) { return "/api/conversations/" + id + "/search/?q=" + encodeURIComponent(q); },
  ...
  BRANCHES: {
    CREATE: function (id) { return "/api/conversations/" + id + "/branch/"; },
    LIST: function (id) { return "/api/conversations/" + id + "/branches/"; },
    SEND: function (id, branchId) { return "/api/conversations/" + id + "/branch/" + branchId + "/send/"; },
    MESSAGES: function (id, branchId) { return "/api/conversations/" + id + "/branch/" + branchId + "/messages/"; },
  },
  ...
  MEMORIES: {
    ...
    DELETE: function (id) { return "/api/conversations/memories/" + id + "/"; },
...
export var CALENDAR = {
  ...
  SKIP_OCCURRENCE: function (id) { return "/api/calendar/events/" + id + "/skip-occurrence/"; },
  MODIFY_OCCURRENCE: function (id) { return "/api/calendar/events/" + id + "/modify-occurrence/"; },
  EXCEPTIONS: function (id) { return "/api/calendar/events/" + id + "/exceptions/"; },
  TEMPLATES:                "/api/calendar/timeblock-templates/",
  TEMPLATE_DETAIL: function (id) { return "/api/calendar/timeblock-templates/" + id + "/"; },
  TEMPLATE_APPLY: function (id) { return "/api/calendar/timeblock-templates/" + id + "/apply/"; },
  ...
  SNOOZE: function (id) { return "/api/calendar/events/" + id + "/snooze/"; },
  DISMISS: function (id) { return "/api/calendar/events/" + id + "/dismiss/"; },
  ...
  SHARING: {
    ...
    REVOKE: function (id) { return "/api/calendar/share/" + id + "/"; },
    SHARE_LINK:      "/api/calendar/share-link/",
    SHARED: function (token) { return "/api/calendar/shared/" + token + "/"; },
    SUGGEST: function (token) { return "/api/calendar/shared/" + token + "/suggest/"; },
  },
  HABITS: {
    LIST:           "/api/calendar/habits/",
    DETAIL: function (id) { return "/api/calendar/habits/" + id + "/"; },
    COMPLETE: function (id) { return "/api/calendar/habits/" + id + "/complete/"; },
    UNCOMPLETE: function (id) { return "/api/calendar/habits/" + id + "/uncomplete/"; },
    STATS: function (id) { return "/api/calendar/habits/" + id + "/stats/"; },
...
export var STORE = {
  ...
  ITEM_PREVIEW: function (slug) { return "/api/store/items/" + slug + "/preview/"; },
...
export var LEAGUES = {
  ...
  LEAGUE_SEASONS: {
    ...
    DETAIL: function (id) { return "/api/leagues/league-seasons/" + id + "/"; },
    CURRENT:        "/api/leagues/league-seasons/current/",
    JOIN:           "/api/leagues/league-seasons/current/join/",
    LEADERBOARD: function (id) { return "/api/leagues/league-seasons/" + id + "/leaderboard/"; },
    CLAIM_REWARDS: function (id) { return "/api/leagues/league-seasons/" + id + "/claim-rewards/"; },
  },
};
...
export var CIRCLES = {
  ...
  POST_VOTE: function (id, postId) { return "/api/circles/circles/" + id + "/posts/" + postId + "/vote/"; },
  CHALLENGES: function (id) { return "/api/circles/circles/" + id + "/challenges/"; },
  CHALLENGE_CREATE: function (id) { return "/api/circles/circles/" + id + "/challenges/create/"; },
...
export var SOCIAL = {
  ...
  POSTS: {
    ...
    REACT: function (id) { return "/api/social/posts/" + id + "/react/"; },
...
export var BUDDIES = {
  ...
  CONTRACTS: {
    ...
    ACCEPT: function (id) { return "/api/buddies/contracts/" + id + "/accept/"; },
    CHECK_IN: function (id) { return "/api/buddies/contracts/" + id + "/check-in/"; },
    PROGRESS: function (id) { return "/api/buddies/contracts/" + id + "/progress/"; },
  },
};
